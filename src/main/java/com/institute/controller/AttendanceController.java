...
public class AttendanceController {
    ...
    public ResponseEntity<?> markAttendance(@RequestBody Map<String, Object> req) {
        ...
        try {
            if (
                    req.get("batchCode") == null ||
                            req.get("facultyId") == null ||

                            req.get("date") == null ||
                            req.get("topic") == null ||
                            req.get("records") == null
            ) {
            ...
            String result = service.saveAttendance(
                    batchCode, facultyId, date, records, topic
            );

            if ("ALREADY_SAVED".equals(result)) {
